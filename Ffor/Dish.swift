...
class Dish: NSObject {
    ...
    convenience init(random: Bool) {
        if random {
            let adjectives = ["Chicken", "Lamb", "Veg", "Salmon", "American", "Italian", "Cheese", "Potato", "Chinese"]
            let nouns = ["Sandwich", "Noodles", "Kebab", "Chops", "Pizza", "Fried Rice", "Fries", "Burger", "Hotdog", "Salad", "Pasta"]
